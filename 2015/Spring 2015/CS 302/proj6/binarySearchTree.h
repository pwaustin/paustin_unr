...
Sorted binary tree class. Uses binary nodes to build the tree. Inherits from unsorted binary
tree class in order to use some of that class's protected helper methods. Does not support
duplicate entries; caveat emptor (!!!). Adapted from textbook code.
