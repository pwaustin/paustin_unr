/** CS 446 Project 5 - supporting data structures, class specification
@file classes.h
...
class Event {
	...
	public:
		...
		bool compPS2 (const Event&) const;
		bool compSJF (const Event&) const;
...
class Data {
	...
	private:
		...
		int quantumNumber;		//new values for process scheduling in version 5
		int schedulingCode;		//convention: 0 for FCFS, 1 for priority, 2 for SJF
	...
	protected:
		...
		void schedule();				//new in project 5
