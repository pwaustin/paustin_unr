...
using namespace std;
	...
	Node::Node(int target, Node* dest)
		{
	...
	bool ListN::insertAfter(int target)
		{
	...
	bool ListN::insertBefore(int target)
		{
	...
	bool ListN::getCursor(int &value) const
		{
	...
	ostream& operator<<(ostream &out, const ListN &src)
		{
	...
	bool ListN::operator==(const ListN &target) const
		{
		...
		//if one is empty but the other isn't, return false
